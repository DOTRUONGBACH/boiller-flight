...
func WrapGQLUnauthenticatedError(ctx context.Context) *gqlerror.Error {
	return WrapGQLError(ctx, "Unauthenticated Request", "UNAUTHENTICATED")
}
...
func WrapGQLInvalidActionError(ctx context.Context) *gqlerror.Error {
	return WrapGQLError(ctx, "Invalid Action", "INVALID_ACTION")
}

func WrapGQLInvalidInputError(ctx context.Context) *gqlerror.Error {
	return WrapGQLError(ctx, "Invalid Input", "INVALID_INPUT")
}
