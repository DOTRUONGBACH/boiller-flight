...
type AccountEdges struct {
	// AccOwner holds the value of the acc_owner edge.
	AccOwner *Customer `json:"acc_owner,omitempty"`
...
// AccOwnerOrErr returns the AccOwner value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e AccountEdges) AccOwnerOrErr() (*Customer, error) {
	if e.loadedTypes[0] {
		if e.AccOwner == nil {
			// Edge was loaded but was not found.
			return nil, &NotFoundError{label: customer.Label}
		}
		return e.AccOwner, nil
	}
	return nil, &NotLoadedError{edge: "acc_owner"}
}
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case account.FieldEmail, account.FieldPassword, account.FieldRole, account.FieldStatus:
...
// QueryAccOwner queries the "acc_owner" edge of the Account entity.
func (a *Account) QueryAccOwner() *CustomerQuery {
	return (&AccountClient{config: a.config}).QueryAccOwner(a)
}
